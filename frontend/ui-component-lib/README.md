...
`@hmcts/ui-component-lib` is an SSR-first package for shared HMCTS shell
...
- `@hmcts/ui-component-lib`
- `@hmcts/ui-component-lib/policy`
- `@hmcts/ui-component-lib/footer`
- `@hmcts/ui-component-lib/client`

Template and style exports:

- `@hmcts/ui-component-lib/nunjucks/macro.njk`
- `@hmcts/ui-component-lib/nunjucks/footer.njk`
- `@hmcts/ui-component-lib/styles/ui-component-lib.css`
...
{
  "dependencies": {
    "@hmcts/ui-component-lib": "file:../../frontend/ui-component-lib"
  }
}
```
...
```ts
import { buildHeaderModel } from '@hmcts/ui-component-lib';
...
```ts
import { buildFooterModel } from '@hmcts/ui-component-lib';
...
const uiComponentLibTemplatesPath = path.dirname(
  require.resolve('@hmcts/ui-component-lib/nunjucks/footer.njk')
);
...
const uiComponentLibStylesPath = path.dirname(
  require.resolve('@hmcts/ui-component-lib/styles/ui-component-lib.css')
);
...
```ts
import { buildFooterModel, buildHeaderModel } from '@hmcts/ui-component-lib';
...
```ts
import { initUiComponentLibEnhancements } from '@hmcts/ui-component-lib/client';
```
