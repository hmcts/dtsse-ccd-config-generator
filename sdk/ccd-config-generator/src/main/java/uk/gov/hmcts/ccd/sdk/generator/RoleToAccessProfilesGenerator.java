...
@Component
public class RoleToAccessProfilesGenerator<T, S, R extends HasRole>
  ...
  private static Map<String, Object> toJson(
      String caseType, CaseRoleToAccessProfile caseRoleToAccessProfile) {
    ...
    if (caseRoleToAccessProfile.getLiveFrom() != null) {
      field.put(
          "LiveFrom",
          caseRoleToAccessProfile.getLiveFrom().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
    }
