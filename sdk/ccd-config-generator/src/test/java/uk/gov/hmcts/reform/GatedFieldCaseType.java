...
import static uk.gov.hmcts.reform.GatedFieldState.Open;
import static uk.gov.hmcts.reform.GatedFieldState.Submitted;
...
public class GatedFieldCaseType
    implements CCDConfig<GatedFieldCaseData, GatedFieldState, UserRole> {

  @Override
  public void configure(ConfigBuilder<GatedFieldCaseData, GatedFieldState, UserRole> builder) {
