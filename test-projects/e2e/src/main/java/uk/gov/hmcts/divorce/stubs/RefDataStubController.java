...
/**
 * Reference-data stub endpoints (staff and court venues). Document endpoints live on
 * {@link DmStoreStubController}, whose {@link StubDocumentStore} is the single source of
 * document state.
 */
@RestController
