...
import static uk.gov.hmcts.divorce.sow014.nfd.ProcessCategoryIdentifiers.*;
...
public enum NFDTaskType {
  ...
  issueDecisionNotice("Issue decision notice", None),
  ...
  vetNewCaseDocuments("Vet new case documents", None),
  ...
  registerNewCase("Register new case", None),
  ...
  reviewSpecificAccessRequestJudiciary("Review Specific Access Request Judiciary", None),
  reviewSpecificAccessRequestLegalOps("Review Specific Access Request Legal Ops", None),
  reviewSpecificAccessRequestAdmin("Review Specific Access Request Admin", None),
  reviewSpecificAccessRequestCTSC("Review Specific Access Request CTSC", None),
  ...
  NFDTaskType(String taskName, ProcessCategoryIdentifiers processCategoryIdentifier) {
    this.taskName = taskName;
    this.processCategoryIdentifier = processCategoryIdentifier;
  }

  public static List<NFDTaskType> getTaskTypesFromProcessCategoryIdentifiers(
