...
- [CCD Config Generator ![Java CI](https://github.com/hmcts/ccd-config-generator/workflows/Java%20CI/badge.svg?branch=master) ![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/hmcts/ccd-config-generator?label=release)](#ccd-config-generator---java-ci--https---githubcom-hmcts-ccd-config-generator-workflows-java-20ci-badgesvg-branch-master----github-tag--latest-semver---https---imgshieldsio-github-v-tag-hmcts-ccd-config-generator-label-release-)
  * [Why](#why)
