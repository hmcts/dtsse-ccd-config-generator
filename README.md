...
Pull requests are very welcome. Please ensure the [tests](https://github.com/hmcts/dtsse-ccd-config-generator/blob/master/sdk/ccd-config-generator/src/test/java/uk/gov/hmcts/ccd/sdk/E2EConfigGenerationTests.java) have been updated to cover any new or altered functionality. The tests are based on comparing the generated JSON output to [expected](https://github.com/hmcts/dtsse-ccd-config-generator/tree/master/sdk/ccd-config-generator/src/test/resources/CARE_SUPERVISION_EPO) - expected output should be added to/modified as necessary.
